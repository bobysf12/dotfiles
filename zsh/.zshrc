...
plugins=(git nvm rsync ssh-agent zsh-autosuggestions zsh-syntax-highlighting)
...
[[ -d "/Applications/Kitty.app/Contents/MacOS" ]] && export PATH="$PATH:/Applications/Kitty.app/Contents/MacOS"
